...
def _ensure_user(email: str, password: str = 'Pinova2026!') -> User:
...
class OtpVerifySecurityTests(APITestCase):
    ...
    def test_lockout_after_max_attempts(self):
        ...
        self.assertEqual(r.data.get('code'), 'pinova_otp_locked')
...
class OtpResendSecurityTests(APITestCase):
    ...
    def test_resend_cooldown(self):
        ...
        self.assertEqual(r2.data.get('code'), 'pinova_otp_resend_cooldown')
