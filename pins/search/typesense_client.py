...
from .schemas import ALL_SCHEMAS, BOARDS_COLLECTION, PINS_COLLECTION, USERS_COLLECTION

logger = logging.getLogger('pinova.search.typesense')
...
def search_pin_ids(query: str, *, limit: int, exclude_author_id: int | None = None) -> list[int]:
