...
MOVES: dict[str, str] = {
    ...
    "media_access.py": "media/access.py",
    "media_cache.py": "media/cache.py",
    "media_views.py": "media/views.py",
    "storage_backends.py": "media/storage.py",
...
IMPORT_REPLACEMENTS: list[tuple[str, str]] = [
    ...
    ("pinova_backend.media.access", "pinova_backend.media.access"),
    ("pinova_backend.media.cache", "pinova_backend.media.cache"),
    ("pinova_backend.media.views", "pinova_backend.media.views"),
    ("pinova_backend.media.storage", "pinova_backend.media.storage"),
...
RELATIVE_FIXES: list[tuple[str, str]] = [
    ...
    ("from pinova_backend.media.access import", "from pinova_backend.media.access import"),
    ("from pinova_backend.media.views import", "from pinova_backend.media.views import"),
