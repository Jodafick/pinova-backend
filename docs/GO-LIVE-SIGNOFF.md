...
|---|-----|:-----:|--------|-------------|------|
| 1 | **Sécurité** | 10/10 | [`PENTEST-REPORT.md`](./PENTEST-REPORT.md) ; `pinova_backend/tests_pentest_internal` ; headers HSTS/CSP | Tech lead sécurité | 2026-06-06 |
...
| 7 | **Dette technique** | 10/10 | [`TECH-DEBT-AUDIT.md`](./TECH-DEBT-AUDIT.md) ; `@pinova/shared` ; `pnpm ci:verify` | Tech lead | 2026-06-06 |
...
2. Compléter la section **Revue avocat** dans `pins/legal_defaults.py` (placeholder → signataire réel).
