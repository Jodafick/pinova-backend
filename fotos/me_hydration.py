"""
Données paginées pour GET/PATCH `me/` : 1ère page tableaux + fotos créés + enregistrés.
...
from fotos.serializers import BoardSerializer, FotoSerializer
from fotos.views import BoardViewSet, FotoViewSet
...
def _pins_page_bundle(
    ...
    *,
    ...
    ser = FotoSerializer(chunk, many=True, context={'request': main_request})
    next_url = None
