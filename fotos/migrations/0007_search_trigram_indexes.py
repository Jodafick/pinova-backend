"""Index GIN pg_trgm — fotos.title, hashtags, author username, boards, profils."""
...
CREATE INDEX IF NOT EXISTS pins_foto_title_trgm_gin
    ON pins_pin USING gin (title gin_trgm_ops);

CREATE INDEX IF NOT EXISTS pins_foto_description_trgm_gin
...
REVERSE_SQL = """
DROP INDEX IF EXISTS pins_foto_title_trgm_gin;
DROP INDEX IF EXISTS pins_foto_description_trgm_gin;
