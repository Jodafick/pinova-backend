...
from fotos.moderation import _profanity_in, validate_foto_text
from fotos.text_blocklist import contains_blocked_text
...
class TextModerationPermissiveTests(SimpleTestCase):
    ...
    def test_validate_foto_title_allows_everyday_content(self):
        validate_foto_text('Mon pot de Mayo', 'Atelier éducation sexuelle', ['cuisine'], [])
