...
class AnalyticsModuleTests(SimpleTestCase):
    def test_capture_noop_without_api_key(self):
        from pinova_backend.observability.analytics import capture_event
    ...
    def test_capture_revenue_recorded_xof(self):
        ...
        from pinova_backend.observability.analytics import capture_revenue_recorded

        with patch('pinova_backend.observability.analytics.capture_event', return_value=True) as mock_capture:
    ...
    def test_capture_checkout_success_emits_revenue_and_checkout(self):
        ...
        from pinova_backend.observability.analytics import capture_checkout_success
