"""Ajoute X-Pinova-Unread-Notifications sur les réponses API (JWT Bearer) sans requête dédiée côté client."""
...
UNREAD_NOTIFICATION_HEADER = 'X-Pinova-Unread-Notifications'
UNREAD_HDR_CACHE_PREFIX = 'pinova:unread_ns_hdr:'
